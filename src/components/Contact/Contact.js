          ...
          <div class="-mx-4 flex flex-wrap lg:justify-evenly">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="text-white mb-4 block text-base font-semibold">
                  Contact Us
                </span>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-white text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-white text-base">
                      99 S.t Jomblo Park 28292. Indonesia
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-white text-base">(+62)81 414 257 9980</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-white text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-white text-base">info@yourdomain.com</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* <div className="xl:px-20 px-6 xl:mx-auto xl:container">
        <div className=" relative sm:flex items-center justify-center">
          ...
          <img
            src="/hi-removebg.png"
            alt=""
            className="sm:hidden  block w-full h-96 object-cover object-fill absolute z-0"
          />
