...
function About() {
  ...
  return (
    <div>
      ...
      <div ref={ref} class="py-48 bg-stone-900">
        <div class="container m-auto px-6 text-white md:px-12 xl:px-6">
          <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div class="md:7/12 lg:w-6/12">
              ...
              <p class="mt-6 text-white font-light text-base font-assistant tracking-wide text-justify">
              ...
              <p class="mt-4 text-white font-light text-basefont-assistant tracking-wide text-justify">
                {" "}
              ...
              <a
                href={Resume}
                download
                class="lg:inline-block mt-2  font-assistant tracking-widest text-sm text-white font-bold  hover:text-orange-200"
              >
                DOWNLOAD CV / RESUME
              </a>
            </div>
